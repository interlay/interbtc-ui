import { CHANGE_REEDEM_STEP, CHANGE_VAULT_BTC_ADDRESS, CHANGE_VAULT_DOT_ADDRESS, RESET_REDEEM_WIZARD,
    CHANGE_AMOUNT_POLKA_BTC, CHANGE_BTC_ADDRESS, RedeemActions } from "../types/actions.types";
