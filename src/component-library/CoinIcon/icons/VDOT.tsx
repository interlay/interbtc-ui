...
const VDOT = forwardRef<SVGSVGElement, IconProps>((props, ref) => (
  <Icon {...props} ref={ref} viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
    ...
    <g clipPath='url(#a)'>
      ...
      />
      <path fill='url(#c)' stroke='#fff' d='M18.5 23.5a5 5 0 1 0 0-10 5 5 0 0 0 0 10Z' />
      <path
        fill='#fff'
        d='m18.454 20.945-2.404-3.52a.29.29 0 0 1 .246-.45h1.069c.096 0 .185.046.24.122l.854 1.171a.3.3 0 0 0 .482 0l.853-1.171a.298.298 0 0 1 .241-.121h1.069c.236 0 .377.257.246.448l-2.404 3.52a.3.3 0 0 1-.492 0Z'
      />
    </g>
    <defs>
      <linearGradient id='b' x1='12' x2='12' y1='.536' y2='23.951' gradientUnits='userSpaceOnUse'>
      ...
      <linearGradient id='c' x1='17.938' x2='17.938' y1='23' y2='14' gradientUnits='userSpaceOnUse'>
        <stop stopColor='#fff' />
