    ...
    return (
      <InterlayButtonBase
        ...
        className={clsx(
          ...
          'focus:ring',
          {
            [clsx('focus:border-interlayDenim-300', 'focus:ring-interlayDenim-200')]:
              process.env.REACT_APP_RELAY_CHAIN_NAME === POLKADOT
          },
          {
            [clsx('dark:focus:border-kintsugiSupernova-300', 'dark:focus:ring-kintsugiSupernova-200')]:
          ...
          disabledOrPending
            ...
            : clsx(
                {
                  [clsx('text-white', 'bg-interlayDenim', 'hover:bg-interlayDenim-600')]:
                    process.env.REACT_APP_RELAY_CHAIN_NAME === POLKADOT
                },
                {
                  [clsx('text-mineShaft', 'dark:bg-kintsugiSupernova', 'dark:hover:bg-kintsugiSupernova-600')]:
                    process.env.REACT_APP_RELAY_CHAIN_NAME === KUSAMA
                }
              ),
