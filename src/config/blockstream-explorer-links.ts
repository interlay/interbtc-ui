...
const BTC_EXPLORER_BLOCK_API =
  IS_BTC_MAINNET ?
    MAINNET_BTC_EXPLORER_BLOCK_API :
    TESTNET_BTC_EXPLORER_BLOCK_API;
const BTC_EXPLORER_ADDRESS_API =
  IS_BTC_MAINNET ?
    MAINNET_BTC_EXPLORER_ADDRESS_API :
    TESTNET_BTC_EXPLORER_ADDRESS_API;
const BTC_EXPLORER_TRANSACTION_API =
  IS_BTC_MAINNET ?
    MAINNET_BTC_EXPLORER_TRANSACTION_API :
    TESTNET_BTC_EXPLORER_TRANSACTION_API;

export {
  BTC_EXPLORER_BLOCK_API,
  BTC_EXPLORER_ADDRESS_API,
  BTC_EXPLORER_TRANSACTION_API
};
