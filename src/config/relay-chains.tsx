...
let COMPETITION_FEEDBACK_LINK: string;
let COMPETITION_DASHBOARD_LINK: string;
let COMPETITION_ISSUES_LINK: string;
...
switch (process.env.REACT_APP_RELAY_CHAIN_NAME) {
  ...
  case KUSAMA: {
    ...
    COMPETITION_FEEDBACK_LINK = KINTSUGI_COMPETITION_FEEDBACK_LINK;
    COMPETITION_DASHBOARD_LINK = KINTSUGI_COMPETITION_DASHBOARD_LINK;
    COMPETITION_ISSUES_LINK = KINTSUGI_COMPETITION_ISSUES_LINK;
