...
const lend = (t: TFunction, params: LoanLendSchemaParams): z.ZodEffects<any, any, any> =>
  z
    .string()
...
const withdraw = (t: TFunction, params: LoanWithdrawSchemaParams): z.ZodEffects<any, any, any> =>
  z
    .string()
    .transform(transformNaN)
    .superRefine((value, ctx) => {
