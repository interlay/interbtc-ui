...
const IssueRequestModal = ({
  ...
  const receivedWrappedTokenAmount = request.execution
  ...
  const sentBackingTokenAmount =
    // TODO: double-check
    (receivedWrappedTokenAmount as WrappedTokenAmount).add(bridgeFee as WrappedTokenAmount);
          ...
          <div className='space-y-6'>
            ...
            <div className='space-y-4'>
              ...
              <div className={clsx('flex', 'justify-between')}>
                ...
                <span className='font-medium'>{shortAddress(request.vaultBackingAddress)}</span>
              </div>
            </div>
