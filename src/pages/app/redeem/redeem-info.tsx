                ...
                <div className="col-12">
                    <div className="wizard-item mt-5">
                        <div className="row">
                            ...
                            <div className="col-6">
                                <img src={BitcoinLogo} width="40px" height="23px" alt="bitcoin logo"></img>{request && request.amountPolkaBTC} BTC
                            </div>
                        </div>
                    </div>
                </div>
