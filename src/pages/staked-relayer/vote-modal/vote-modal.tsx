    ...
    return (
        <Modal show={props.show} onHide={props.onClose} size="lg">
            <Modal.Header closeButton>
                <Modal.Title>Vote on Status Update Proposal #{props.parachain && props.parachain.id}</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                {props.parachain && (
                    <React.Fragment>
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-9 col-lg-8 col-md-6">
                                <span
                                    className={
                                        props.parachain.proposedStatus === "Running" ? " green-text" : " orange-text"
                                    }
                                >
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-9 col-lg-8 col-md-6">
                                <span
                                    className={
                                        props.parachain.currentStatus === "Running" ? " green-text" : " orange-text"
                                    }
                                >
